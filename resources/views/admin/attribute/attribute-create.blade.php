                    ...
                    <div class="col-xxl-8 col-lg-10 m-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="theme-form theme-form-2 mega-form" method="POST" action="{{ url('admin/attribute', []) }}">
                                    @csrf
                                    <div class="mb-4 row align-items-center">
                                        <label class="form-label-title col-sm-3 mb-0" for="attribute_name">Attribute Name</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" id="attribute_name" name="name" placeholder="Attribute Name">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row g-sm-4 g-3">
                                                <div class="col-sm-10 col-9">
                                                    <input class="form-control" type="text" id="attribute_value" name="value" placeholder="Attribute Value">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
