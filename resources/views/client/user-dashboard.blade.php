                    ...
                    <div class="dashboard-left-sidebar">
                        ...
                        <div class="profile-box">
                            <div class="cover-image">
                                <img src="assets_client/images/inner-page/cover-img.jpg" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                                        ...
                                        <div class="row g-sm-4 g-3">
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="assets_client/images/svg/order.svg"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="assets_client/images/svg/order.svg" class="blur-up lazyload"
                                                        alt="">
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="assets_client/images/svg/pending.svg"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="assets_client/images/svg/pending.svg"
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    <img src="assets_client/images/svg/wishlist.svg"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="assets_client/images/svg/wishlist.svg"
                                                        class="blur-up lazyload" alt="">
                                                    <div class="totle-detail">
                                                ...
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="assets_client/images/cake/product/2.png"
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                            <div class="product-box-3 theme-bg-white h-100">
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="assets_client/images/cake/product/3.png"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                            <div class="product-box-3 theme-bg-white h-100">
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="assets_client/images/cake/product/4.png"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                            <div class="product-box-3 theme-bg-white h-100">
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="assets_client/images/cake/product/5.png"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                            <div class="product-box-3 theme-bg-white h-100">
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="assets_client/images/cake/product/6.png"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                            <div class="product-box-3 theme-bg-white h-100">
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="assets_client/images/cake/product/7.png"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                            ...
                                            <div class="order-box dashboard-bg-box">
                                                ...
                                                <div class="product-order-detail">
                                                    ...
                                                    <div class="order-wrap">
                                                        ...
                                                        <p class="text-content"> {{ $cart->products->meta_description }}
                                                        </p>
                                                        <ul class="product-size">
                                                            ...
                                                            <li>
                                                                <div class="size-box">
                                                                    ...
                                                                    <h5>{{ $cart->products->categorys->category_name }}
                                                                    </h5>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li>
                                                                <div class="size-box">
                                                                    <h6 class="text-content">Quantity
                                                                        : </h6>
                                                                    <h5>{{ $cart->quantity }}</h5>
                                                                </div>
                                                            </li>
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="assets_client/images/payment-icon/1.jpg"
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details card-visa">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="assets_client/images/payment-icon/2.jpg"
                                                                class="img-fluid blur-up lazyloaded" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details dabit-card">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="assets_client/images/payment-icon/3.jpg"
                                                                class="img-fluid blur-up lazyloaded" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="dashboard-profile">
                                    ...
                                    <div class="profile-about dashboard-bg-box">
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-5">
                                                <div class="profile-image">
                                                    <img src="assets_client/images/inner-page/dashboard-profile.png"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            </div>
                                        </div>
